...
public final class updatetotaldeduct_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      if (_jspx_eval_sql_update_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("    \n");
          out.write("    \n");
          out.write("    update total set total_deduct=(SELECT (d.provident_fund+d.advance+d.tax)From deduction d  where employee_id=?) ;\n");
          out.write("    \n");
  ...
  private boolean _jspx_meth_c_out_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_0, PageContext _jspx_page_context)
    ...
    _jspx_th_c_out_0.setValue(new String("Data Set Successfully"));
